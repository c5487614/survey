...
document.write('<iframe style="position:absolute;width:206px;display:none;z-index:99" name="divCalendar" id="divCalendar" frameborder="0" scrolling="no"></iframe>')
...
'#SelectYear,#SelectMonth{position:absolute;top:21px;z-index:99;overflow:hidden;display:none;}'+
'--></style><scr'+
